...
async function seedDatabase() {
  ...
  for (const school of schools) {
    db.run(
      ...
      [school.name, school.address, school.city, school.state, school.zip]
    )
  }
  ...
  for (const company of companies) {
    db.run(
      ...
      [company.name, company.address, company.city, company.state, company.zip, company.website, company.is_donor]
    )
  }
  ...
  for (const person of people) {
    db.run(
      `INSERT INTO people (first_name, middle_name, last_name, email, phone, title, is_donor, is_fc_certified, is_board_member)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [person.first_name, person.middle_name, person.last_name, person.email, person.phone, person.title, person.is_donor, person.is_fc_certified, person.is_board_member]
    )
  }
  console.log('People seeded.')

  // Seed person type assignments
  db.run('INSERT INTO person_type_assignments (person_id, type_id) VALUES (1, 1)')
  db.run('INSERT INTO person_type_assignments (person_id, type_id) VALUES (2, 1)')
  db.run('INSERT INTO person_type_assignments (person_id, type_id) VALUES (3, 2)')
  db.run('INSERT INTO person_type_assignments (person_id, type_id) VALUES (4, 1)')
  db.run('INSERT INTO person_type_assignments (person_id, type_id) VALUES (4, 2)')
  db.run('INSERT INTO person_type_assignments (person_id, type_id) VALUES (6, 2)')
  console.log('Person type assignments seeded.')

  // Seed person-company relationships
  db.run('INSERT INTO person_companies (person_id, company_id, is_primary) VALUES (1, 1, 1)')
  db.run('INSERT INTO person_companies (person_id, company_id, is_primary) VALUES (5, 3, 1)')
  db.run('INSERT INTO person_companies (person_id, company_id, is_primary) VALUES (5, 4, 0)')
  db.run('INSERT INTO person_companies (person_id, company_id, is_primary) VALUES (7, 2, 1)')
  console.log('Person-company relationships seeded.')

  // Seed person-school relationships
  db.run('INSERT INTO person_schools (person_id, school_id) VALUES (2, 1)')
  db.run('INSERT INTO person_schools (person_id, school_id) VALUES (3, 2)')
  db.run('INSERT INTO person_schools (person_id, school_id) VALUES (4, 1)')
  db.run('INSERT INTO person_schools (person_id, school_id) VALUES (6, 3)')
  console.log('Person-school relationships seeded.')

  // Seed certifications for FC certified people
  db.run(`INSERT INTO certifications (person_id, background_check_status, application_received, training_complete) VALUES (1, 'approved', 1, 1)`)
  db.run(`INSERT INTO certifications (person_id, background_check_status, application_received, training_complete) VALUES (2, 'approved', 1, 1)`)
  db.run(`INSERT INTO certifications (person_id, background_check_status, application_received, training_complete) VALUES (4, 'pending', 1, 0)`)
  ...
  for (const donation of donations) {
    db.run(
      ...
      [donation.amount, donation.date, donation.note, donation.person_id, donation.company_id]
    )
  }
  ...
  for (const note of notes) {
    db.run(
      ...
      [note.title, note.content, note.date, note.entity_type, note.entity_id]
    )
  }
