...
async function seedDatabase() {
  ...
  // Seed companies
  const companies = [
    { name: 'Tech Solutions Inc', address: '100 Tech Park', city: 'Springfield', state: 'IL', zip: '62701', website: 'https://techsolutions.example.com', is_donor: true },
    { name: 'Community Foundation', address: '200 Main St', city: 'Springfield', state: 'IL', zip: '62702', website: 'https://communityfound.example.com', is_donor: true },
    { name: 'Local Business Group', address: '300 Commerce Dr', city: 'Springfield', state: 'IL', zip: '62703', website: 'https://localbiz.example.com', is_donor: false },
    { name: 'Education Partners LLC', address: '400 Partnership Way', city: 'Springfield', state: 'IL', zip: '62704', website: 'https://edupartners.example.com', is_donor: true },
  ]
  ...
  // Seed people
  const people = [
    { first_name: 'John', middle_name: 'Robert', last_name: 'Smith', email: 'john.smith@example.com', phone: '555-0101', title: 'Program Director', is_donor: true, is_fc_certified: true, is_board_member: true },
    { first_name: 'Sarah', middle_name: 'Jane', last_name: 'Johnson', email: 'sarah.johnson@example.com', phone: '555-0102', title: 'Volunteer Coordinator', is_donor: false, is_fc_certified: true, is_board_member: false },
    { first_name: 'Michael', middle_name: null, last_name: 'Williams', email: 'michael.w@example.com', phone: '555-0103', title: 'Teacher', is_donor: true, is_fc_certified: false, is_board_member: false },
    { first_name: 'Emily', middle_name: 'Grace', last_name: 'Brown', email: 'emily.brown@example.com', phone: '555-0104', title: 'Parent Volunteer', is_donor: false, is_fc_certified: true, is_board_member: false },
    { first_name: 'David', middle_name: 'Lee', last_name: 'Davis', email: 'david.davis@example.com', phone: '555-0105', title: 'Business Owner', is_donor: true, is_fc_certified: false, is_board_member: true },
    { first_name: 'Jennifer', middle_name: null, last_name: 'Miller', email: 'jennifer.m@example.com', phone: '555-0106', title: 'School Principal', is_donor: false, is_fc_certified: false, is_board_member: false },
    { first_name: 'Robert', middle_name: 'James', last_name: 'Wilson', email: 'robert.wilson@example.com', phone: '555-0107', title: 'Community Leader', is_donor: true, is_fc_certified: false, is_board_member: true },
  ]

  for (const person of people) {
    await sql`INSERT INTO people (first_name, middle_name, last_name, email, phone, title, is_donor, is_fc_certified, is_board_member)
      VALUES (${person.first_name}, ${person.middle_name}, ${person.last_name}, ${person.email}, ${person.phone}, ${person.title}, ${person.is_donor}, ${person.is_fc_certified}, ${person.is_board_member})`
  }
